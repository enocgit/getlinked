...
const schema = z.object({
  ...
  group_size: z.number().gt(0, { message: "Group size can't be zero" }),
        ...
        <div className="relative w-full max-w-[35rem] rounded-md bg-transparent md:bg-white/3 md:p-14 md:shadow-md">
          ...
          >
            <div className="col-span-2 space-y-1 sm:col-span-1 md:max-xl:col-span-2">
              ...
              />
              <small className="it text-xs text-red-500">
            ...
            <div className="col-span-2 space-y-1 sm:col-span-1 md:max-xl:col-span-2">
              ...
              />
              <small className="it text-xs text-red-500">
                {errors.project_topic && <p>{errors.project_topic?.message}</p>}
              </small>
            </div>
            <div className="col-span-2 space-y-1 sm:col-span-1 md:max-xl:col-span-2">
              ...
              >
                ...
                {/* <option value="" className="text-neutral-800">2</option>
                <option value="" className="text-neutral-800">3</option> */}
              </select>
            </div>
            <div className="col-span-2 space-y-1 sm:col-span-1 md:max-xl:col-span-2">
            ...
            <div className="col-span-2 flex items-start gap-2">
              <Checkbox defaultSelected size="sm" className="" />I agreed with
              the event terms and conditions and privacy policy
            </div>
